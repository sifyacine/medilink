        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              TProfileMenu(icon: Iconsax.copy, title: 'User-ID', value: controller.user.value.id, ),
              ...
              TProfileMenu(onPressed: () {}, title: 'Gender', value: controller.user.value.gender.toString(), ),
              TProfileMenu(onPressed: () {}, title: 'Date  Of Birth', value: controller.user.value.dateOfBirth.toString(), ),

              const Divider(),
              const SizedBox(height: TSizes.spaceBtwItems,),

              Center(
                child: TextButton(onPressed: () => controller.deleteAccountWarningPopup() ,child: const Text('Close Account', style: TextStyle(color: Colors.redAccent),)),
              )
